export const didYouKnow = [
  ...
  {
    id: 2,
    data: ['<a href="https://www.npmjs.com/package/mocha.parallel">Mocha Parallel</a> es una librería super útil de <code>Javascript</code> que sirve para ejecutar tests en paralelo. Esto nos proporciona el tiempo de ejecución de los test de manera sustancial.']
  },
  {
    id: 3,
    data: [
