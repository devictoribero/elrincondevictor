export const books = [
  /* TECHNICAL */
  {
    ...
    img_src: "/img/book-clean-code.jpg",
    review: {
      rate: 5,
      text: [
  ...
  },
  {
    ...
    img_src: "/img/book-clean-architecture.jpg",
    review: {
      rate: 5,
      text: [
  ...
  },
  {
    ...
    img_src: "/img/book-working-effectively-with-legacy-code.jpg",
    review: {
      rate: 5,
      text: [
  ...
  },
  {
    ...
    img_src: "/img/book-the-pragmatic-programmer.jpeg",
    review: {
      rate: 5,
      text: [
  ...
  /* PRODUCTIVITY */
  {
    ...
    img_src: "/img/book-the-one-thing.jpg",
    review: {
      rate: 5,
      text: [
  ...
  /* FINANCIAL INTELLIGENCE */
  {
    ...
    img_src: "/img/book-the-intelligent-investor.jpg",
    review: {
      rate: 5,
      text: [
  ...
  /* SOFT SKILLS */
  {
    ...
    img_src: "/img/book-inteligencia-emocional.jpg",
    review: {
      rate: 5,
      text: [
  ...
  },
  {
    ...
    img_src: "/img/book-soft-skills.jpg",
    review: {
      rate: 4,
      text: [
  ...
  },
  {
    ...
    img_src: "/img/book-como-ganar-amigos.jpg",
    review: {
      rate: 5,
      text: [
  ...
  /* DESARROLLO PERSONAL */
  {
    ...
    img_src: "/img/book-el-elemento.jpg",
    review: {
      rate: 5,
      text: [
  ...
  {
    title: "Find Your Why",
    img_src: "/img/book-find-your-why.jpg",
    review: {
      rate: 5,
      text: [
  ...
  /* EMPRENDIMIENTO */
  {
    ...
    img_src: "/img/book-creativity-inc.jpg",
    review: {
      rate: 5,
      text: [
  ...
  /* OTHER */
  {
    ...
    img_src: "/img/book-homo-deus.jpg",
    review: {
      rate: 5,
      text: [
